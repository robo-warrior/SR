...
class EDSR(nn.Module):
  ...
  """
    ...
    def __init__(self, upscale_factor, num_blocks=36, **kwargs):
        ...
        self.add_module('init_conv', Conv2d(3, 256, 3)) # Change to (4,256,3) fir alpha channel
        ...
        self.add_module(
            'reconst',
            nn.Sequential(OrderedDict([('reconst_conv0', Conv2d(256, 3, 3))]))) # Change to (256,4,3) for alpha channel
