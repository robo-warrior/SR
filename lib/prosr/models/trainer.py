...
from ..utils.misc import  tensor2imMine
...
class SimultaneousMultiscaleTrainer(object):
    ...
    def __init__(self,
        ...
        self.tensor2imMine = lambda t: tensor2imMine(t, mean=training_dataset.dataset.mean,
                                             stddev=training_dataset.dataset.stddev)
    ...
    #     disp = self.get_current_visuals()
    #     # input_imgs = disp['input']
    #     output_imgs = disp['output']
    #     image_dir = "./outputs/output_images/"
    #     self.make_dir(image_dir)
    #
    ...
    #     #     io.imsave(output_imgs[i], save_path)
    #
    #     image_name = '%1.png'
    #     save_path = os.path.join(image_dir, image_name)
    #     io.imsave(output_imgs, save_path)
